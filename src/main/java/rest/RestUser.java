...
public class RestUser
{
	...
	*/
	...
	// Bug in JRE1.7 apperantly..
	
	@DELETE
	@Path("/{input}")
	public void deleteUser(@PathParam("input") String input)
	{
		userService.deleteUser(input);
	}
	
	@PUT
	@Path("/{currentname}/{newpassword}")
	public void editUser(@PathParam("currentname") String currentname, @PathParam("newpassword") String newpassword)
	{
		userService.changePassword(currentname, newpassword);
	}
